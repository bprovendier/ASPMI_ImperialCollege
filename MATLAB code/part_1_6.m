...
xlabel('Singular value Index'); ylabel('Singular Value magnitude');
...
xlabel('Singular value Index'); ylabel('Square Error');
...
legend('Noise corrupted', 'Denoised', 'Interpreter','latex'); hold off;
immse(X, Xnoise)
